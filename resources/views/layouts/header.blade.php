                    ...
                    <div class="account-card">
                      <div class="header-top-account-info">
                        ...
                        <div class="account-body">
                          <h5><a href="#">{{auth()->user()->fname ?? null}}&nbsp;{{auth()->user()->lname ?? null}}</a></h5>
                        <span class="mail">{{auth()->user()->email ?? null}}</span>
                        </div>
                      </div>
                        ...
                        <ul class="account-item-list">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                        ...
                                        <span class="ti-power-off"></span>{{ __('Logout') }}
                                    </a>
          ...
          <div class="col-md-6">
            <div class="breadcrumb-area">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item" aria-current="page"><i class="fa fa-home"></i>  Dashboard</li>
                  @yield('breadcrumb')
                </ol>
              </nav>
            </div>
